...
struct MinimalisticMusicView: View {
    ...
    private var albumArtView: some View {
        // Concentric with the closed notch's 14pt bottom outer corner, 6pt padding:
        // r = 14 − 6 = 8pt. Aspect-ratio-sensitive aesthetic halving kept for
        // source-landscape artwork so the visible letterboxed image still reads rounded.
        ...
        let radius = aspectLandscape ? concentricRadius / 2 : concentricRadius
        return HStack {
            Color.clear
