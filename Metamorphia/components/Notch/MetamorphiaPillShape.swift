...
/// A pill-shaped (capsule-like) clip shape used for the Island mode
...
/// floating style.
struct MetamorphiaPillShape: Shape {
...
#Preview {
    VStack(spacing: 20) {
        MetamorphiaPillShape(cornerRadius: 16)
            .fill(.black)
            .frame(width: 185, height: 32)

        MetamorphiaPillShape(cornerRadius: 24)
            .fill(.black)
