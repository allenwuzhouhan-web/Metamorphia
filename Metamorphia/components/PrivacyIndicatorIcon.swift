...
struct PrivacyIndicatorIcon: View {
    ...
    // Matches PrivacyLiveActivity's native macOS colors:
    // camera = #26CC41 (green), mic = #FF9402 (orange).
    private var indicatorColor: Color {
        switch type {
        case .camera:
            return Color(red: 0.152, green: 0.804, blue: 0.256)
        case .microphone:
            return Color(red: 1.000, green: 0.584, blue: 0.010)
        }
    }
