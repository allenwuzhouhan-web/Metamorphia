...
final class LocalSendService: NSObject, ObservableObject {
        ...
        for scheme in schemes {
            for path in paths {
                ...
                components.queryItems = [
                    URLQueryItem(name: "fingerprint", value: "metamorphia.localsend.bridge"),
                ]
                ...
                do {
                    ...
                    guard let http = response as? HTTPURLResponse,
                          ...
                          fingerprint != "metamorphia.localsend.bridge"
                    else {
                        continue
                    }
    ...
    private func sendAnnouncement() {
        let payload: [String: Any] = [
            "alias": Host.current().localizedName ?? "Metamorphia",
            "version": "2.1",
            "deviceModel": "Mac",
            "deviceType": "desktop",
            "fingerprint": "metamorphia.localsend.bridge",
            ...
            // when Metamorphia is not serving LocalSend register endpoint.
            "protocol": "http",
            "download": false,
            "announcement": true,
            "announce": true,
    ...
    private func processRegisterRequest(data: Data, from endpoint: NWEndpoint) -> Data {
        ...
        if method == "POST", path == "/api/localsend/v2/register" || path == "/api/localsend/v3/register" {
            ...
            let responseJSON: [String: Any] = [
                ...
                "deviceModel": "Mac",
                "deviceType": "desktop",
                "token": "metamorphia.localsend.bridge",
                "fingerprint": "metamorphia.localsend.bridge",
                "download": false,
    ...
    private func handleIncoming(content: Data, endpoint: NWEndpoint?) {
        ...
        if fingerprint == "metamorphia.localsend.bridge" { return }
