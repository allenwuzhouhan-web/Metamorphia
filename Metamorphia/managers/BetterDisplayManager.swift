...
/// - Observe OSD notifications from BetterDisplay and route them to Metamorphia's HUD pipeline
...
final class BetterDisplayManager: ObservableObject {
    ...
    private weak var coordinator: MetamorphiaViewCoordinator?
    ...
    func configure(coordinator: MetamorphiaViewCoordinator) {
    ...
    /// Route a decoded BetterDisplay OSD notification to the active Metamorphia HUD variant.
