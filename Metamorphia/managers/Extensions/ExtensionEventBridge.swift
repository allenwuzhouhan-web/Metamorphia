...
/// Bridges extension payload updates between Metamorphia processes (main app, helpers, XPC services).
...
final class ExtensionEventBridge {
    ...
    private let ioQueue = DispatchQueue(label: "com.johannendersmith.metamorphia.extensions.bridge", qos: .utility)
    ...
    private func snapshotURL(for channel: Channel) -> URL {
        ...
        let directory = appSupport.appendingPathComponent("MetamorphiaExtensions", isDirectory: true)
        switch channel {
        case .liveActivities:
    ...
    private enum Channel: CustomStringConvertible {
        ...
        var notificationName: Notification.Name {
            switch self {
            case .liveActivities:
                return Notification.Name("com.johannendersmith.metamorphia.extensions.liveActivitySnapshot")
            case .lockScreenWidgets:
                return Notification.Name("com.johannendersmith.metamorphia.extensions.lockScreenWidgetSnapshot")
            case .notchExperiences:
                return Notification.Name("com.johannendersmith.metamorphia.extensions.notchExperienceSnapshot")
            }
        }
