...
final class MusicControlWindowManager {
    ...
    @discardableResult
    func present(using viewModel: MetamorphiaViewModel, metrics: MusicControlWindowMetrics) -> Bool {
    ...
    @discardableResult
    func refresh(using viewModel: MetamorphiaViewModel, metrics: MusicControlWindowMetrics) -> Bool {
    ...
    private func frame(for size: CGSize, viewModel: MetamorphiaViewModel, screen: NSScreen, metrics: MusicControlWindowMetrics) -> NSRect {
