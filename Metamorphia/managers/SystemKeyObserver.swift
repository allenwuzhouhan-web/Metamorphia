...
class SystemKeyObserver: NSApplication {
    static let volumeChanged = Notification.Name("Metamorphia.volumeChanged")
    static let brightnessChanged = Notification.Name("Metamorphia.brightnessChanged")
    static let keyboardIlluminationChanged = Notification.Name("Metamorphia.keyboardIlluminationChanged")
