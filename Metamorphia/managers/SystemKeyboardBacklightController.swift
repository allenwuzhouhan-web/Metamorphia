...
extension Notification.Name {
    static let keyboardBacklightDidChange = Notification.Name("Metamorphia.keyboardBacklightDidChange")
}
...
final class SystemKeyboardBacklightController {
    ...
    private let workerQueue = DispatchQueue(label: "com.metamorphia.keyboardBacklight", qos: .userInitiated)
