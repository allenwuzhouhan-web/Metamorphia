...
extension Notification.Name {
    static let systemVolumeDidChange = Notification.Name("Metamorphia.systemVolumeDidChange")
    static let systemBrightnessDidChange = Notification.Name("Metamorphia.systemBrightnessDidChange")
    static let systemAudioRouteDidChange = Notification.Name("Metamorphia.systemAudioRouteDidChange")
}
...
final class SystemVolumeController {
    ...
    /// the blocks accumulate (and keep firing) on the old device every time the
    /// system output device changes.
