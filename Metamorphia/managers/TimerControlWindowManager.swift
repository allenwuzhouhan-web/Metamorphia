...
final class TimerControlWindowManager {
    ...
    @discardableResult
    func present(using viewModel: MetamorphiaViewModel, metrics: TimerControlWindowMetrics) -> Bool {
    ...
    @discardableResult
    func refresh(using viewModel: MetamorphiaViewModel, metrics: TimerControlWindowMetrics) -> Bool {
    ...
    private func resolveScreen(from viewModel: MetamorphiaViewModel) -> NSScreen? {
    ...
    private func frame(for size: CGSize, viewModel: MetamorphiaViewModel, screen: NSScreen, metrics: TimerControlWindowMetrics) -> NSRect {
